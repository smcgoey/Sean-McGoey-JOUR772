...
# download information from csv URL
average_county_pills_per_year <- read_csv(county_url)
...
# Changed to load 2014 variables to ensure that the code I found in the 2012 version was the same -SNM
acs_variables <- load_variables(2014, "acs5")
...
state_white_only_population <- get_acs(geography = "state", 
