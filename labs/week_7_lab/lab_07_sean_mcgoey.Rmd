...
# NOTE: Error seems to be resolved when running through rstudio.cloud. Still troubleshooting why I'm getting the error on my machine. -SNM
...
# Same as previous instance, error is resolved when running in rstudio.cloud. -SNM
