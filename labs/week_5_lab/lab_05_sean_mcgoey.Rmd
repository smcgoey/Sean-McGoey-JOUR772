...
# View mingo in new tab - COMMENTING OUT ONCE COMPLETE
#View(mingo)

# Glimpse the data in mingo
glimpse(mingo)

# Summary of data in mingo
summary(mingo)
...
# Question for Sean: Why is as_date required? Would sorting, filtering, etc. still work when treating the date as a string of characters?
...
# As with total shipments, the number of pills shipped to Mingo County spiked in 2007-09 - peaking in 2008 with 7,496 shipments totaling 9,795,100 pills - before decreasing in the 2010s.
